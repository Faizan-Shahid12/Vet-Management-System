 ...
 */
public class ManagePrescriptionController implements Initializable 
{
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sda/VetViews/ViewPrescription.fxml"));
        Parent buyMedicineScreen = loader.load();
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sda/VetViews/CustomizePrescription.fxml"));
        Parent buyMedicineScreen = loader.load();

        CustomizePrescriptionController controller = loader.getController();
        controller.setSelectedPet(SelectedPet);
    ...
    {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/sda/VetViews/DeletePrescription.fxml"));
        Parent buyMedicineScreen = loader.load();
        ...
        scene = new Scene(buyMedicineScreen);
        stage.setScene(scene);
        stage.setTitle("Complete Prescription");
        stage.show();
    }
