...
public class RegistrationController {
    ...
    public void onRegisterButtonClicked(ActionEvent event) throws IOException  
    {
        ...
        if (contact.isEmpty() || !contact.matches("^0\\d{10}$")) 
        {
            showAlert("Error", "Contact Number Invalid.", AlertType.ERROR);
            return;
        }
        ...
        Cont.RegisterPetOwner(username, password, fullName, gender, Period.between(dobPicker.getValue(), LocalDate.now()).getYears(), email, dob, contact);
